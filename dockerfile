...
## find your URL, go to https://console.rumble.run/deploy/download/explorers 
## and click on the first URL box to copy it to the clipboard.
##
ENV AGENT_URL=https://console.rumble.run/download/explorer/[UNIQUE-TOKEN]/AF0293999/rumble-explorer-linux-amd64.bin
